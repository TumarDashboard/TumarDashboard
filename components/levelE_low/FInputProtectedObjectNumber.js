...
const minlength = process.env.NEXT_PUBLIC_MIN_LENGTH_PROTECTED_OBJECT_NUMBER_INPUT;
const maxlength = process.env.NEXT_PUBLIC_MAX_LENGTH_PROTECTED_OBJECT_NUMBER_INPUT;

export function FInputProtectedObjectNumber({ id, className, onChange, placeholder, ...props }) {
