  ...
  const saveChanges = async (event) => {
    ...
    try {
      if (currentUser && currentUser?.id) {
        ...
        const responce = await changeUser(
          currentUser.id, 
          uriAvatar, 
          inputSurname, 
          inputFirstName, 
          inputPatronymic, 
          ARchangeUserPositions ? inputPositions : undefined
        );
    ...
    return (
      ...
      >
        ...
        >
          ...
          {!ARchangeUserPositions && (currentUser?.positions?.length > 0) &&
          ...
          {!ARchangeUserPositions && (currentUser?.positions?.length == 0 || !currentUser?.positions) &&
            <div className="form-item select-none">
